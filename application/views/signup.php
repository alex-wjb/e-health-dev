...
<?php echo validation_errors();?>
    ...
    <form method="post" action="<?php echo base_url('index.php/create-account');?>">
        <input type="text" name ="username" placeholder="Must have at least 3 characters" value="<?php echo set_value('username');?>" minlength= "3" maxlength="20" required></input><br><br>
        <input type="text" name ="password" placeholder="" minlength= "3" maxlength="20" required></input><br><br>
